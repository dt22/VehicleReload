...
- VehicleReloadConfig.cs: Example of ModConfig for custom mod settings;
- VehicleReloadGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- VehicleReloadMain.cs: Main mod class, recieves mod management and general events;
- VehicleReloadTactical.cs: Example of ModTactical for modifying tactical level;
